...
const systemTimeline = [
  { icon: CheckCircle, color: "text-green-500", title: "Security Patch Deployed", time: "Just now · 2 mins ago" },
  { icon: Info, color: "text-blue-500", title: "New Enterprise.Com Partnership", time: "24 Thg10 · 11:45 CH" },
  { icon: AlertTriangle, color: "text-orange-500", title: "Payment Threshold Warning", time: "23 Thg10 · 09:20 SA" },
  { icon: AlertTriangle, color: "text-red-500", title: "Fraud Detection Alert", time: "21 Thg10 · 14:10 CH" },
  { icon: CheckCircle, color: "text-green-500", title: "System Backup Complete", time: "20 Thg10 · 03:00 SA" },
];
            ...
            <div className="flex items-end gap-1.5 h-28">
              {barHeights.map((height, i) => (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full rounded-sm bg-[#2563eb]" style={{ height: `${height}%` }} />
