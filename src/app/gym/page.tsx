...
import {
  ...
  CalendarCheck2, DollarSign, Banknote, WalletCards,
  Bell, Search, TrendingUp, TrendingDown, LogOut, Plus,
  FileText, XCircle, Clock, Settings,
} from "lucide-react";
import { useAuthStore } from "@/modules/auth/auth.store";
import { useRouter } from "next/navigation";

const gymLinks = [
  { href: "/gym", label: "Bảng điều hành", icon: LayoutDashboard, active: true },
  ...
  return (
    <div className="flex min-h-screen bg-[#f1f5f9]">
      ...
      <aside className="w-60 shrink-0 bg-white border-r border-gray-100 flex flex-col min-h-screen">
        ...
        {/* User info — at TOP, right below brand */}
